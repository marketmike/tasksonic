...
include_once($physical_path['Site_Lang'].'dispute_task_completed_success.php');
...
##############################################################################################
	$tpl->assign(array(	"T_Body"			=>	'Msg'. $config['tplEx'],
						...
						"info"		   		=>	$lang['info'],
						"pagename"			=>	'Dipute Completed',
						"navigation"		=>	'<a href=task_'.$_GET['project_id'].'_' . $clean_url . '.html class=footerlink>Return to task "'.$ret->project_title.'"</a>',
