...
<div class="right-column-wrap">
	...
	<a href="{$Site_URL}/post-new-task.html">Post Task</a>
	</div>
	</div>
	<img src="{$Templates_Image}task_symbol.png" border="0" style="float:left;margin-left:10px;width:125px;" />	
	<div class="clear"></div>	
</div><!--right-column-wrap-->
{if $tasker_commission && $task_owner_commission && $tasker_minimum && $task_owner_minimum }
<div class="right-column-wrap">
 <h3>Current Task Fees</h3>
 <div class="clear"></div>
 <strong>Task Owner:</strong> {$task_owner_commission}% of awarded bid - min fee ${$task_owner_minimum}
 <div class="clear"></div>
 <strong>Tasker:</strong> {$tasker_commission}% of awarded bid - min fee ${$tasker_minimum}
 <div class="clear"></div>
...
<img src="images/background-verified.png" style="float:left;margin-right:1px;width:45px;height:45px" alt="Background Checked" title="Background Checked" />	
 ...
 <div class="clear"></div>
	<div class="buttons-tall" style="margin-top:10px;">
	<a href="{$Site_URL}/faq_details_28.html">Learn More</a>
	</div> 
 <div class="clear"></div>	
</div><!--right-column-wrap-->	