...
<div class="grid_12 push_12 alpha omega content_body"> 
	...
	<h1>{$lang.Forgotpassword_Page}</h1>
				...
				<div class="clear"></div>
					...
					<div class="clear"></div>
						...
						<form method="post" action="{$smarty.server.PHP_SELF}" name="frmForgotpasswd">
							...
							<div class="field">							
							<div class="buttons">
							<button type="submit" name="Submit" value="{$lang.Button_Submit}" onClick="Javascript: return Check_Details(this.form);">Send Password</button>
							</div>
							<div class="clear"></div>
							</div>							
