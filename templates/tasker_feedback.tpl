				...
				<div class="clear"></div>
							...
							<strong>Rated on:</strong> {$arating[rating].date_time} | <strong>Rated by:</strong> <a href="tasker_profile_{$arating[rating].rating_by_user}.html" class="footerlink">{$arating[rating].rating_by_user}</a>
											 {if $arating[rating].count != ''} 
											   <a href="{$arating[rating].rating_by_user}_task_owner_feedback.html" class="footerlink">({$arating[rating].count})</a>
											 {else}
											   <a href="{$arating[rating].rating_by_user}_task_owner_feedback.html" class="footerlink">(0)</a>
											{/if}
							|
