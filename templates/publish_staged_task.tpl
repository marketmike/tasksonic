...
<div class="grid_12 push_12 alpha omega content_body"> 
	...
	<h1>Publish Your Task In {$citycurrent}</h1>
<div class="page_top"></div>
        <div class="page_content">
            <div class="page_content_white">
			<div class="clear"></div>
			{if $User_Id == $Recevier_id && $stage_id}
				...
				{/if}	
					...
					<div class="clear"></div>
					<div class="field">
						<input name="en_project_title" value="{$en_project_title}" type="text" maxlength="40" tabindex="1" size="50" />
					...
					<div class="field">
							<div class="buttons">
							<button type="submit" name="Submit" value="{$lang.Submit}"  onClick="Javascript: return Check_Details(this.form);">Publish Your Task</button>
							</div>
					</div>
					<div class="clear"></div>					
						...
						<input type="hidden" name="stage_id" value="{$staged_id}" />						
				</form>		
				{else}
					<div class="title-links" style="width:100%;">
						<div class="form_page_text" style="text-align:center;">
							<label for="login-email-address">Task Not Found</label>
						</div>
					</div>
					<div class="clear"></div>
				{if $stage_id}	
				<div class="message" style="margin:0 auto;text-align:center;width:400px;padding:20px;">This does not to appear to be your unpublished task. If you feel this is inaccurate, please contact the site administrator by clicking on the <a href="contact_us.html">contact us</a> link. To create a new task <a href="post-new-task.html">click here</a></div>				
				{else}
				<div class="message" style="margin:0 auto;text-align:center;width:400px;padding:20px;">The unpublished task you are looking for does not appear to exist. If you feel this is inaccurate, please contact the site administrator by clicking on the <a href="contact_us.html">contact us</a> link. To create a new task <a href="post-new-task.html">click here</a></div>
				{/if}
				{/if}
