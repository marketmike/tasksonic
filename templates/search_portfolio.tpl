				...
				{if $Loop > 0}
					...
					<div id="all_tasks" class="{cycle values='list_B style3, list_A style3'}" >
						...
						{if $smarty.foreach.files_name.total == 1}
							<div style="float:left;margin-left:10px;margin-right:10px;"><a href="javascript:OpenImage('{$files_name->sample_file}')"><img src="{$img_path}{$files_name->sample_file}" border="0" height="100" width="100" style="margin:0px" /></a></div>
						{else}
							<div style="float:left;margin-right:10px;"><a href="javascript:OpenImage('{$files_name->sample_file}')"><img src="{$img_path}{$files_name->sample_file}" border="0" height="100" width="100" style="margin:0px" /></a></div>
						{/if}
						{/foreach}
						...
						{if $smarty.foreach.files_name.total == 3}
							<div style="float:left;margin-right:10px;"><a href="javascript:OpenImage('{$files_name->sample_file}')"><img src="{$img_path}default-portfolio.png" border="0" height="100" width="100" style="margin:0px" /></a></div>
							<div style="float:left;margin-right:10px;"><a href="javascript:OpenImage('{$files_name->sample_file}')"><img src="{$img_path}default-portfolio.png" border="0" height="100" width="100" style="margin:0px" /></a></div>							
						{/if}
