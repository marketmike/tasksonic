<?php /* Smarty version 2.6.26, created on 2012-08-23 12:21:58
         compiled from task_owner_feedback.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'task_owner_feedback.tpl', 16, false),array('modifier', 'intval', 'task_owner_feedback.tpl', 19, false),array('modifier', 'string_format', 'task_owner_feedback.tpl', 28, false),)), $this); ?>
<div class="grid_12 push_12 alpha omega content_body"> 
   <div class="grid_8 alpha">
<h1><?php echo $this->_tpl_vars['user']; ?>
's Task Owner Feedback</h1>
...
_tasker_feedback.html" class="footerlink">(<?php echo $this->_tpl_vars['arating'][$this->_sections['rating']['index']]['count']; ?>
)</a>
											 <?php else: ?>
											   <a href="<?php echo $this->_tpl_vars['arating'][$this->_sections['rating']['index']]['rating_by_user']; ?>
