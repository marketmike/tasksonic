<?php /* Smarty version 2.6.26, created on 2012-08-14 08:46:31
         compiled from default_layout_orig.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'urlencode', 'default_layout_orig.tpl', 368, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><?php echo $this->_tpl_vars['Site_Title']; ?>
 - Content Experiment Version II Homepage</title>
...
/home.html"><span <?php if ($this->_tpl_vars['nav_select'] == home): ?>class="selected"<?php endif; ?>>Home</span></a>&nbsp;|&nbsp;</li>
				<?php if ($_SESSION['User_Name']): ?>
                <li><a href="<?php echo $this->_tpl_vars['Site_URL']; ?>
/latest-open-tasks.html"><span <?php if ($this->_tpl_vars['nav_select'] == latest): ?>class="selected"<?php endif; ?>>Open</span></a>&nbsp;|&nbsp;</li>
				<?php else: ?>
...
/task-categories.html"><span <?php if ($this->_tpl_vars['nav_select'] == categories): ?>class="selected"<?php endif; ?>>Categories</span></a>&nbsp;|&nbsp;</li>
				...
				<?php if ($_SESSION['User_Name']): ?>
                <li><a href="<?php echo $this->_tpl_vars['Site_URL']; ?>
/completed-tasks.html"><span <?php if ($this->_tpl_vars['nav_select'] == completed): ?>class="selected"<?php endif; ?>>Completed</span></a>&nbsp;|&nbsp;</li>			
				<?php endif; ?>				
				<?php if ($_SESSION['User_Name']): ?>
                <li><a href="<?php echo $this->_tpl_vars['Site_URL']; ?>
