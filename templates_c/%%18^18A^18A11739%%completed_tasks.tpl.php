<?php /* Smarty version 2.6.26, created on 2012-08-14 13:56:34
         compiled from completed_tasks.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'completed_tasks.tpl', 45, false),array('modifier', 'urlencode', 'completed_tasks.tpl', 58, false),array('modifier', 'stripslashes', 'completed_tasks.tpl', 58, false),array('modifier', 'truncate', 'completed_tasks.tpl', 80, false),)), $this); ?>
<div class="grid_12 push_12 alpha omega content_body">
	 
   <div class="grid_8 alpha">   
	<h1>Completed Tasks For <?php echo $this->_tpl_vars['citycurrent']; ?>
</h1>
	<div class="clear"></div>			
...
<br />
 ...
 at <?php echo $this->_tpl_vars['view_project'][$this->_sections['ProList']['index']]['completed_time']; ?>
		...
		<?php echo $this->_tpl_vars['view_project'][$this->_sections['ProList']['index']]['bid']; ?>
			...
			<?php if ($this->_tpl_vars['view_project'][$this->_sections['ProList']['index']]['status'] == 5): ?>Marked Completed<?php endif; ?>
