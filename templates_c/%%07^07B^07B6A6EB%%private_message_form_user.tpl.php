<?php /* Smarty version 2.6.26, created on 2012-08-14 09:45:19
         compiled from private_message_form_user.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'private_message_form_user.tpl', 91, false),)), $this); ?>
...
" onclick="javascript : window.close();"/>					
					<?php else: ?>
						...
						<?php if ($_SESSION['User_Name'] == $this->_tpl_vars['bid_user']): ?>
...
" onclick="javascript : window.close();"/>
						<?php else: ?>
								...
								<div class="note" style="text-align:center;padding:20px;">Only the task owner can send a private message to <?php echo $this->_tpl_vars['lang']['bid_user']; ?>
<</div>
								<input class="login_txt style5" type="submit" id="btnbg" name="Submit" value="<?php echo $this->_tpl_vars['lang']['Button_Close']; ?>
" onclick="javascript : window.close();"/>
								<?php else: ?>
...
"</label>
 ...
 <?php echo $this->_tpl_vars['bid_user']; ?>
</div>
								<div class="clear"></div>
 ...
 should use the Private Message system to stay in touch throughout the completion process.<br /><br />While we encourage you to use the Private Messaging system for all communication, we do realize that alternate means of communication can at times be more effective for certain types of tasks. Exchanging contact information for this purpose is permitted as needed to complete the task.
								...
								<div class="title-links" style="width:400px;">
									<div class="form_page_text" style="text-align:right;">
										<label for="login-email-address">Post Message To <?php echo $this->_tpl_vars['bid_user']; ?>
</label>
									</div>
								</div>
...
" />
						<input type="hidden" name="bid_user" value="<?php echo $this->_tpl_vars['bid_user']; ?>
" />
