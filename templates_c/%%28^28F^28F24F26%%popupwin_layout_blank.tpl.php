<?php /* Smarty version 2.6.26, created on 2012-08-14 22:15:32
         compiled from popupwin_layout_blank.tpl */ ?>
<html>
<head>
...
popup.css" rel="stylesheet" type="text/css">
...
<body>
<div id="main">
<?php if ($this->_tpl_vars['no_head_footer'] == 1): ?>
<?php else: ?>
<div style="margin:0 auto;margin-bottom:20px;text-align:center"><a href="home.html"><img src="<?php echo $this->_tpl_vars['Templates_Image']; ?>
logo_dark.png" border="0"/></a></div>
<?php endif; ?>
<div class="clear"></div>
