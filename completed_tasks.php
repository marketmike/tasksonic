...
$home_content = $home_page_content->ShowHomePage(5);
##############################################################################################
...
$tpl->assign(array(	"T_Body"						=>	'completed_tasks'. $config['tplEx'],
...
$proj->ViewAll_projects_by_city_completed($citycurrent);
