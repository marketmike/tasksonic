...
$col_one = $home_page_content->ShowHomePage(7);
$col_two = $home_page_content->ShowHomePage(8);
$col_three = $home_page_content->ShowHomePage(9);
// creating objects
$cats 		= new Category();
$proj	 	= new project();
...
$tpl->assign(array(	"T_Body"			=>	'logged_out_home'. $config['tplEx'],
					"JavaScript"		=>	array('home.js'),
					"lang"				=>  $lang,
					"cat_id"  	  		=>	$arr_cat1_id,
					...
					"marketing_col_one"			=>	$col_one->home_content,	
					"marketing_col_two"			=>	$col_two->home_content,	
					"marketing_col_three"			=>	$col_three->home_content,						
					"nav_select"			=>	'home', 					
			));
##############################################################################################
}
