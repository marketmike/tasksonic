...
function render_footer() {
	global $onload_js;
	$html = "<div class='footer'>demo by <a href='http://www.facebook.com/profile.php?id=1174181864'>Chris Weitenberner</a></div>";
	$html .= "</div>";
...
function render_logged_out_index() {
	...
	$html .= '<h1>Login to this application using facebook</h1>';
	$html .= '</div>';
