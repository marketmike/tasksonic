...
$notify_email =  "marketmike@gmail.com";         //email address to which debug emails are sent to
$DB_Server = "myserver"; //your MySQL Server
$DB_Username = "dbuser"; //your MySQL User Name
$DB_Password = "222222"; //your MySQL Password
