...
/* FOR KINTU DESIGNS */
/*
if(!in_array('/home/content/G/a/n/Ganeshkrupa/html/rockoff/includes/common.php',get_included_files()))
{
	define('IN_SITE', 	true);
	include_once("/home/content/G/a/n/Ganeshkrupa/html/rockoff/includes/common.php");
}
*/



//$spaw_dir = '/rockoff/editor/';

// base url for images
$spaw_base_url = $virtual_path['Editor'];

$HTTP_SERVER_VARS['DOCUMENT_ROOT'] = $physical_path['Editor'];

$spaw_root = $HTTP_SERVER_VARS['DOCUMENT_ROOT'];
...
$spaw_dropdown_data['paragraph']['<h1>'] = 'Heading 2';
...
$spaw_dropdown_data['paragraph']['<h1>'] = 'Heading 6';
...
$spaw_imglibs = array(
  array(
    'value'   => $upload_dir."site/",
    'text'    => 'Site',
  ),
   array(
    'value'   => $upload_dir."others/",
    'text'    => 'Others',
  ),
);
