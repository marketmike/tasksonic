...
<head>
  ...
  <?php if (SPAW_Util::getBrowser() == 'Gecko') { ?>
    ...
    var wnd = window.open(spaw_dir + 'dialogs/colorpicker.php?lang=<?php echo $_GET["lang"]?>&theme=<?php echo $_GET["theme"]?>&editor=<?php echo $_GET["editor"]?>&callback=showColorPicker_callback', 
      "color_picker", 
  ...
  <?php if (SPAW_Util::getBrowser() == 'Gecko') { ?>
    ...
    var wnd = window.open(spaw_dir + 'dialogs/img_library.php?lang=<?php echo $_GET["lang"]?>&theme=<?php echo $_GET["theme"]?>&editor=<?php echo $_GET["editor"]?>&callback=showImgPicker_callback',
      "img_library", 
      'status=no,modal=yes,width=420,height=420'); 

  <?php }else{ ?>

    var imgSrc = showModalDialog(spaw_dir + 'dialogs/img_library.php?theme=<?php echo $theme?>&lang=<?php echo $l->lang?>&request_uri=<?php echo $request_uri?>', '', 
