...
{
	header("location: withdraw_moneybooker.php");
	exit();
}
...
{  
	...
	header("location: withdraw_moneybooker.php?edit=true");
	exit();
}
elseif($Action=='DeleteSelected')
{
	...
	header("location: withdraw_moneybooker.php?delall=true");
	exit();
}
#=======================================================================================================================================
...
if($Action == 'ViewAll' || $Action == '')
{
	...
	$pays->WithdrawDetails_of_Moneybooker();
	$rscnt = $db->num_rows();
	...
	$tpl->assign(array( "T_Body"			=>	'withdarw_showall'. $config['tplEx'],
						...
						"A_Action"		    =>	"withdraw_moneybooker.php",
