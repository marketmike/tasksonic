<?php /* Smarty version 2.6.26, created on 2012-08-25 22:47:08
         compiled from home_page_slider_manage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'home_page_slider_manage.tpl', 33, false),)), $this); ?>
...
title_bg.gif" height="25">Home Page Slider</td>
	...
	<tr>
		<td valign="top" align="center">
			<table border="0" cellpadding="1" cellspacing="2" width="95%">
				...
				<tr>
					<td class="varnormal">
						Manage image slider for the Home Page.
					</td>
				</tr>
...
add.gif" class="imgAction" title="Add" border="0"></a>&nbsp;</td>
				...
				<tr>
					<td class="headTitle" width="20%">Slide Image URL</td>
...
">
					<td class="varnormal">&nbsp;<?php echo $this->_tpl_vars['Page']->slide_url; ?>
</td>
					<td align="center">
						<img src="<?php echo $this->_tpl_vars['Templates_Image']; ?>
edit.gif" class="imgAction" title="Edit" onClick="JavaScript: Edit_Click('<?php echo $this->_tpl_vars['Page']->slide_id; ?>
');">&nbsp;
					</td>
				</tr>
				<?php endforeach; else: ?>
