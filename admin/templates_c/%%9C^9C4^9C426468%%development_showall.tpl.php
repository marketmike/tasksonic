<?php /* Smarty version 2.6.26, created on 2012-08-23 10:26:50
         compiled from development_showall.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'development_showall.tpl', 51, false),)), $this); ?>
...
<table border="0" cellpadding="0" cellspacing="1" width="95%" class="stdTableBorder" align="center">
	<form name="frmDevelopment" action="<?php echo $this->_sections['PHP_SELF']; ?>
" method="post" >
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" height="25">Task Cost Management </td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<td valign="top" align="center">
			<table border="0" cellpadding="1" cellspacing="2" width="95%">
				...
				<tr>
					<td class="varnormal">
						Manage Development Cost. Add/Edit/Delete Development Cost.
					<div align="right">Page Size:
					  <select name="page_size" onChange="JavaScript: document.frmDevelopment.submit();">
...
">
					<td><input class="stdCheckBox" type="checkbox" name="cat_prod[]" value="<?php echo $this->_tpl_vars['development_id'][$this->_sections['country']['index']]; ?>
"></td>
					<td width="28%" class="bodytextblack">&nbsp;<?php echo $this->_tpl_vars['development_title'][$this->_sections['country']['index']]; ?>
</td>
					<td align="center">
						<img src="<?php echo $this->_tpl_vars['Templates_Image']; ?>
edit.gif" 	class="imgAction" title="Edit" onClick="JavaScript: Edit_Click('<?php echo $this->_tpl_vars['development_id'][$this->_sections['country']['index']]; ?>
');">&nbsp;&nbsp;
					  	<img src="<?php echo $this->_tpl_vars['Templates_Image']; ?>
delete.gif"	class="imgAction" title="Delete" onClick="JavaScript: Delete_Click('<?php echo $this->_tpl_vars['development_id'][$this->_sections['country']['index']]; ?>
');">&nbsp;&nbsp;</td>
				</tr>
				<?php endfor; else: ?>
				<tr>	
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td colspan="3" align="center" class="bodytextblack">No development cost inserted yet.</td>
				</tr>
				<?php endif; ?>
			</table>
