...
<div class="form_page_text" style="text-align:center;">
	<label for="login-email-address">
		Other HP Pages Manager [{$Action}]
	</label>
</div>
</div>
<div class="clear"></div>
<table border="0" cellpadding="0" cellspacing="1" width="95%" class="stdTableBorder" align="center">
	<form name="frmPage" action="page.php" method="post" enctype="multipart/form-data">
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" background="{$Templates_Image}title_bg.gif" height="25">Other HP Pages Manager [{$Action}] </td>
		...
		<td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="2" width="95%">
				<tr>
					...
					<td width="75%" class="fieldLabelLeft"><input type="text" name="page_title" value="{$page_title}"></td>
				</tr>
			</table>
