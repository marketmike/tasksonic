...
<div class="form_page_text" style="text-align:center;">
	<label for="login-email-address">
		Paypal's Pending Request [ {$Action} ]
	</label>
</div>
</div>
<div class="clear"></div>
	...
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" height="25">Paypal's Pending Request [ {$Action} ]</td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<td valign="top" align="center">
			<table border="0" cellpadding="1" cellspacing="2" width="95%">
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td align="center"><strong>{$Action} Paypal's Pending Request.</strong></td>
				</tr>
