	...
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" background="{$Templates_Image}title_bg.gif" height="25">Country Order Management </td>
					...
					<td width="25%">
						<select name="category" style="width:250px;" size="30">
							{section name=Opt loop=$Loop}
								<option value="{$country_id[Opt]}">{$country_title[Opt]}</option>
							{/section}
						</select>
