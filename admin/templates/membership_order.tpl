	...
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" background="{$Templates_Image}title_bg.gif" height="25">Portfolio Management </td>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="27%">
					...
					<td width="25%">
						<select name="category" style="width:200px;" size="10">
							{section name=Opt loop=$Loop}
								<option value="{$membership_id[Opt]}">{$membership_name[Opt]}</option>
							{/section}
						</select>
				...
				<tr>
					<td>
						...
						<input type="submit" name="Submit" value="Cancel" class="stdButton" onclick="JavaScript: return cancel();"> 					
