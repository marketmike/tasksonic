...
<div class="form_page_text" style="text-align:center;">
	...
	Contact Us Management [ {$Action} ]					
	</label>
</div>
</div>
<div class="clear"></div>
<table border="0" cellpadding="0" cellspacing="1" width="95%" class="stdTableBorder" align="center">
	<form name="frmContactUs" action="{$smarty.server.PHP_SELF}" method="post" >
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" height="25">Contact Us Management [ {$Action} ]</td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="2" width="75%">
				...
				<tr>
					...
					<td class="fieldLabelLeft">
					<span style="line-height:35px"><input class="textbox" type="checkbox" name="status" value="1" {if $status ==1}checked{/if}/>&nbsp;This email has been addressed</span>
					</td>
				</tr>
				<tr>
					<td class="fieldlabelRight" valign="top" width="30%">Action Taken:</td>
					<td class="fieldLabelLeft">
					<textarea name="action_taken" rows="3" cols="80" class="textbox">{$action_taken}</textarea>
					</td>
				</tr>
