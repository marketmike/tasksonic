	...
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" background="{$Templates_Image}title_bg.gif" height="25">Industry Management </td>
					...
					<td width="25%">
						<select name="category" style="width:200px;" size="10">
							{section name=Opt loop=$Loop}
								<option value="{$industry_id[Opt]}">{$industry_name[Opt]}</option>
							{/section}
						</select>
