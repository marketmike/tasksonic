...
<table border="0" cellpadding="0" cellspacing="1" width="95%" class="stdTableBorder" align="center">
	<form name="frmcity" action="{$smarty.section.PHP_SELF}" method="post" >
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" height="25">City Management </td>
	...
	<tr>
		<td valign="top" align="center">
			<table border="0" cellpadding="1" cellspacing="2" width="95%">
				...
				<tr>
					<td class="varnormal">
						Manage City. Add/Edit/Delete City.
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				{section name=city loop=$Loop}
				<tr class="{cycle values='list_A, list_B'}">
					<td><input class="stdCheckBox" type="checkbox" name="cat_prod[]" value="{$city_id[city]}"></td>
					<td width="28%" class="bodytextblack">&nbsp;{$city_name[city]}</td>
					<td align="center">
						<img src="{$Templates_Image}edit.gif" 	class="imgAction" title="Edit" onClick="JavaScript: Edit_Click('{$city_id[city]}');">&nbsp;&nbsp;
					  	<img src="{$Templates_Image}delete.gif"	class="imgAction" title="Delete" onClick="JavaScript: Delete_Click('{$city_id[city]}');">&nbsp;&nbsp;</td>
				</tr>
				{sectionelse}
				<tr>	
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td colspan="3" align="center" class="bodytextblack">No city inserted yet.</td>
				</tr>
				{/section}
			</table>
			{if $smarty.section.city.total > 1}
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				<tr>
