...
<div class="form_page_text" style="text-align:center;">
	<label for="login-email-address">
		Moneybooker's Pending Request [ {$Action} ]
	</label>
</div>
</div>
<div class="clear"></div>
	...
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" height="25">Moneybooker's Pending Request [ {$Action} ]</td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<td valign="top" align="center">
			<table border="0" cellpadding="1" cellspacing="2" width="95%">
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td align="center"><strong>{$Action} Moneybooker's Pending Request.</strong></td>
				</tr>
			...
			<table border="0" cellpadding="1" cellspacing="2" width="75%">
				...
				<tr>
					...
					<td class="fieldLabelLeft">$&nbsp;{$amount}</td>
				</tr>
				<tr>
					<td class="fieldlabelRight" valign="top" width="30%">Description :</td>
					<td class="fieldLabelLeft">{$description}</td>
				</tr>
				<tr>
			...
			<input type="hidden" name="mpd_id" value="{$mpd_id}" />
