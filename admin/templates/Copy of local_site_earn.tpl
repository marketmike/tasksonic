	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td width="31%" class="bodytextblack" align="center">$&nbsp;{$earn_cancel[earn2].Fees}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="3">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">$&nbsp;{$earn_premium[earn3].Fees}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">$&nbsp;{$earn_urgent[earn4].Fees}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
