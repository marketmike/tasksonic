...
<table border="0" cellpadding="0" cellspacing="1" width="95%" class="stdTableBorder" align="center">
	<form name="frmDevelopment" action="{$smarty.section.PHP_SELF}" method="post" >
	<tr>
		<td valign="top">
		...
		<td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				<tr class="{cycle values='list_A, list_B'}">
					<td><input class="stdCheckBox" type="checkbox" name="cat_prod[]" value="{$development_id[country]}"></td>
					<td width="28%" class="bodytextblack">&nbsp;{$development_title[country]}</td>
					<td align="center">
						<img src="{$Templates_Image}edit.gif" 	class="imgAction" title="Edit" onClick="JavaScript: Edit_Click('{$development_id[country]}');">&nbsp;&nbsp;
					  	<img src="{$Templates_Image}delete.gif"	class="imgAction" title="Delete" onClick="JavaScript: Delete_Click('{$development_id[country]}');">&nbsp;&nbsp;</td>
				</tr>
				{sectionelse}
				<tr>	
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
