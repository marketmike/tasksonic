	...
	<tr>
		<td valign="top" colspan="2">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" height="25">Bid Place On Tasks [ {$Action} ]</td>
				</tr>
				<tr>
				    <td>&nbsp;</td>
				</tr>
			...
			<table border="0" cellpadding="1" cellspacing="2" width="75%">
				...
				<tr>
					...
					<td class="fieldLabelLeft">
						<input type="checkbox" name="bid_visible" value="1" class="stdCheckBox" {$bid_status}>{$bid_status}	
					</td>
				</tr>
				<tr>
