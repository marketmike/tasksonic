...
<div class="form_page_text" style="text-align:center;">
	<label for="login-email-address">
		Pending Requests Management (On Paypal)
	</label>
</div>
</div>
<div class="clear"></div>
	...
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" height="25">Pending Requests Management (On Paypal) </td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				<tr>
					<td colspan="6" class="varnormal"><font color="#9D0027">Red Indiacates Deposite money Requested (Pending)</font></td>
				</tr>
				<tr>
					<td colspan="6" class="varnormal"><font color="#339900">Green Indiacates Deposite money Completed</font></td>
				</tr>
				<tr>
				    <td>&nbsp;</td>
				</tr>
			...
			{section name=pending_money loop=$Loop}
				<tr class="{cycle values='list_A, list_B'}">
					...
					{else}
						&nbsp;<font color="#339900">
					{/if}&nbsp;$&nbsp;{$pending[pending_money].amount}</td>
					<td class="bodytextblack">
					{if $pending[pending_money].status == 0}
						&nbsp;<font color="#9D0027">
					{else}
