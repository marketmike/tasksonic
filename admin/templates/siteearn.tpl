...
<div class="form_page_text" style="text-align:center;">
	<label for="login-email-address">
		Site Earn  Management 
	</label>
</div>
</div>
<div class="clear"></div>
<table border="0" cellpadding="0" cellspacing="1" width="95%" class="stdTableBorder" align="center">
	<form name="frmEarn" action="{$smarty.section.PHP_SELF}" method="post" >
	<tr>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="pagetitle" width="49%" height="25">Site Earn  Management </td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
	    <td class="varnormal">&nbsp;
			{if $flag == 0}
			<a href="pdf.php" class="actionLink" target="_blank">Create PDF for Site Earning of All</a>
			{else}
			<a href="pdf_serach.php?start_date={$start_date}&end_date={$end_date}" class="actionLink" target="_blank">Create PDF for Site Earning of Search</a>
			{/if}
		</td>
	</tr>
	<tr>
	...
	<tr>
	    <td align="center" class="varnormal">Search from :  <script>DateInput('start_date', true, 'YYYY-MM-DD')</script></td>
	</tr>
	<tr>
	    <td align="center" class="varnormal">Search to :  <script>DateInput('end_date', true, 'YYYY-MM-DD')</script></td>
	</tr>
	<tr>
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
			 ...
			 <table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td width="31%" class="bodytextblack" align="center">$&nbsp;{$earn_membership[earn].membership_fees}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="3">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">$&nbsp;{$earn_withdraw[earn1].amount}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				<tr>
					<td class="bodytextblack" colspan="4">
						...
						<a href="javascript: show_Withdraw_Money()" class="actionlink"><strong>Form Withdraw Money (Money)</strong></a>
						</span>
						<span id="Withdraw_Hide_Money" style="visibility:hidden;display:none;">
						<a href="javascript: hide_Withdraw_Money()" class="actionlink"><strong>Form Withdraw Money (Money)</strong></a>
						</span>
					</td>
				</tr>
			</table>
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">$&nbsp;{$earn_withdraw_money[earn_money].amount}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">$&nbsp;{if $earn_premium[earn3].Fees != ''}{$earn_premium[earn3].Fees} {else} 0.00 {/if}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">$&nbsp;{if $earn_urgent[earn4].Fees != ''}{$earn_urgent[earn4].Fees}{else}0.00{/if}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
